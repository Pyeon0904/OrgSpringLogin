...
<link rel=stylesheet href="${ path }/resources/css/boardCss/boardViewCss.css"/>
<!-- ------- -->
		...
		<table id="tbl-board" align="center">
			...
			<tr>
				<th colspan="2">
					...
					<button type="button" id="btnList" onclick="location.href='${ path }/board/list'">목록으로</button>
				</th>
			</tr>
		</table>
	</div>
